...
- 221 files · ~154,913 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 2005 nodes · 3702 edges · 169 communities (108 shown, 61 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 615 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `91b4cb30`
...
- Core Principles
- TestAccessLog_AuthenticatedRequest_LogsUserAndTenant
...
6. `Role` - 37 edges
7. `setupWiredAuthHandler()` - 35 edges
8. `setupAuthService()` - 35 edges
...
## Communities (169 total, 61 thin omitted)
...
### Community 11 - "events.go"

Cohesion: 0.11
Nodes (31): BaseEvent, DomainEvent, LoginFailedEvent, LoginSucceededEvent, LogoutEvent, PasswordChangedEvent, RoleChangedEvent, SessionRevokedEvent (+23 more)
...
Cohesion: 0.09
Nodes (71): ModuleConfig, NewAuthEvent(), T, TestAuthEvent_TableName(), TestAuthEvent_WithMetadata(), TestAuthEventType_GormDataType(), TestAuthEventType_String(), TestMetadata_GormDataType() (+63 more)
...
Cohesion: 0.26
Nodes (22): setupE2E(), T, TestE2E_LoginUseRefreshLogout(), NewMockAuthEventRepository(), NewMockPasswordResetRepository(), NewMockSessionRepository(), NewMockTenantRepository(), NewMockUserRepository() (+14 more)
...
Cohesion: 0.28
Nodes (10): Context, User, UUID, ChangePasswordRequest, CreateUserRequest, CreateUserResponse, UnlockRequest, UpdateRequest (+2 more)
...
Cohesion: 0.21
Nodes (12): RegisteredClaims, Time, UUID, NewClaims(), NewTokenPair(), T, TestClaims_GetUserID(), TestClaims_IsExpired() (+4 more)

### Community 112 - "Tasks: Authentication Module"

Cohesion: 0.04
Nodes (48): Account Lockout (FR-011a), Dependencies & Execution Order, Endpoint Protection, Estimated Task Counts, Format: `[ID] [P?] [Story] Description`, Implementation, Implementation, Implementation (+40 more)
...
Cohesion: 0.20
Nodes (35): authedContext(), Context, Request, T, UUID, setupUserHandler(), TestUserHandler_Create_CannotAssignRole(), TestUserHandler_Create_EmailExistsInSameTenant() (+27 more)
...
Cohesion: 0.08
Nodes (25): 1. Login, 2. Access Protected Endpoint, 3. Refresh Token, 4. Logout, Account Lockout, Authentication Flows, Checking Permissions, Complete Reset (+17 more)

### Community 118 - "AuthEvent"

Cohesion: 0.11
Nodes (13): Time, UUID, Value, Context, DB, Time, UUID, Time (+5 more)
...
Cohesion: 0.18
Nodes (14): Module, NewAuthMiddleware(), Router(), UserRouter(), Claims, Context, Time, User (+6 more)
...
Cohesion: 0.24
Nodes (6): Context, DB, Time, UUID, GormPasswordResetRepository, PasswordResetRepository

### Community 129 - "Context"

Cohesion: 0.26
Nodes (4): Context, UUID, MockPasswordResetRepository, MockSessionRepository
...
### Community 138 - "TestAccessLog_AuthenticatedRequest_LogsUserAndTenant"

Cohesion: 0.17
Nodes (12): AccessLog(), Context, Handler, setAccessLogTenantID(), setAccessLogUserID(), capturingLogger, T, TestAccessLog_AuthenticatedRequest_LogsUserAndTenant() (+4 more)

### Community 139 - "Implementation Plan: Authentication Module"

Cohesion: 0.20
Nodes (9): Complexity Tracking, Constitution Check, Design: Request/Response Access Logging (FR-018), Documentation (this feature), Implementation Plan: Authentication Module, Project Structure, Source Code (repository root), Summary (+1 more)
...
Cohesion: 0.19
Nodes (6): Claims, Duration, Time, User, UUID, TokenService
...
Cohesion: 0.47
Nodes (3): Context, UUID, failingEmailer

### Community 161 - "withFields"

Cohesion: 0.21
Nodes (5): withFields(), Event, Field, Logger, zerologLogger

### Community 162 - "capturingLogger"

Cohesion: 0.26
Nodes (6): capturingLogger, Mutex, T, TestAuthHandler_Refresh_LogsSessionLookupFailure(), TestAuthHandler_Refresh_LogsUserLookupFailure(), capturedEntry

### Community 163 - "AuthServiceConfig"

Cohesion: 0.21
Nodes (9): AuthEventRepository, SessionRepository, TenantRepository, UserRepository, UserTenantRoleRepository, AuthServiceConfig, Emailer, RateLimiter (+1 more)

### Community 164 - "GormSessionRepository"

Cohesion: 0.31
Nodes (4): Context, DB, UUID, GormSessionRepository

### Community 165 - "GormUserRepository"

Cohesion: 0.35
Nodes (5): Context, DB, User, UUID, GormUserRepository

### Community 167 - "version_test.go"

Cohesion: 0.31
Nodes (6): IsPreRelease(), T, TestAppName(), TestInfo(), TestIsPreRelease(), TestVersion()

### Community 168 - "LogEmailer"

Cohesion: 0.36
Nodes (4): Context, UUID, NewLogEmailer(), LogEmailer
...
- **578 isolated node(s):** `common.sh script`, `create-new-feature.sh script`, `SPECIFY_FEATURE`, `name`, `version` (+573 more)
...
- **Why does `New()` connect `New` to `GormPasswordResetRepository`, `PasswordResetToken`, `e2eEnv`, `setupUserService`, `UserTenantRole`, `TestAccessLog_AuthenticatedRequest_LogsUserAndTenant`, `events.go`, `session_test.go`, `Seed`, `TestLoginPerformance`, `withFields`, `capturingLogger`, `setupE2E`, `GormSessionRepository`, `GormUserRepository`, `MockUserRepository`, `main`, `setupWiredAuthHandler`, `setupAuthMiddleware`, `UserService`, `KeyManager`, `Claims`, `dto.go`, `setupUserHandler`, `AuthEvent`, `Tenant`, `NewPasswordService`, `AuthService`, `capturingEmailer`?**
...
- **Why does `setupE2E()` connect `setupE2E` to `e2eEnv`, `KeyManager`, `AuthService`, `capturingEmailer`, `decodeBody`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Are the 165 inferred relationships involving `New()` (e.g. with `.seedTenant()` and `.seedUser()`) actually correct?**
  _`New()` has 165 INFERRED edges - model-reasoned connections that need verification._
